...
Par exemple, on peut avoir un fichier MP4 qui contient une piste vidéo provenant d'un codec H.264, une piste audio provenant d'un codec AAC et une piste de sous-titres au format WebVTT.
...
A noter que le MPEG TS permet de simplement concaténer plusieurs fichiers pour obtenir un nouveau fichier MPEG TS valide!
